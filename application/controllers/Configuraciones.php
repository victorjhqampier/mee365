...
class Configuraciones extends CI_Controller {
	...
	public function axconfiguraciones_pruebas(){		
		...
		$lista = $this->serv_ejecucion_app->exe_obtener_dato_tablas_publicas();/*$this->serv_ejecucion_app->arixkernel_obtener_datos('submenu_id, submenu', 'config.v_menu_subapp', 100, 0,'app_id = 1002 AND rol >= 4','',array('submenu_id','submenu'));
